...
public class QGVRAudioCallback {
	...
	public QuakeGVRAudioTrack mAudioTrack;	
	...
	public void initAudio(int size)
	{
		...
		mAudioTrack = new QuakeGVRAudioTrack(AudioManager.STREAM_MUSIC,
				sampleFreq,
...
class QuakeGVRAudioTrack extends AudioTrack
{	
	public QuakeGVRAudioTrack(int streamType, int sampleRateInHz,
